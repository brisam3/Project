...
if (!isset($_GET['fecha_inicio']) || empty($_GET['fecha_inicio']) || !isset($_GET['fecha_fin']) || empty($_GET['fecha_fin'])) {
    ...
    echo json_encode(["error" => "Debe proporcionar un rango de fechas"]);
    exit;
}
...
// Registro de depuración
error_log("Medios de pago locales en rango de fechas: " . print_r($mediosPagoLocales, true));
...
// Registro de depuración
error_log("Medios de pago en rango de fechas: " . print_r($mediosPago, true));
