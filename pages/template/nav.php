...
<div class="layout-page">
    ...
    <div class="content-wrapper">
                ...
                <ul class="menu-inner">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0)" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Locales">Locales</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/wol/pages/administracion/reportes/reportes.php" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-store"></i>
                                    <div data-i18n="Subir Reporte Diario">Reporte</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/wol/pages/administracion/reportes/reporteVentas.php" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-store"></i>
        ...
        document.getElementById('logoutButton').addEventListener('click', () => {
            fetch('../../backend/controller/login/logoutController.php', {
                    method: 'POST',
                })
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            title: '<strong>¡Hasta pronto!</strong>',
                            html: '<b>Tu sesión ha sido cerrada</b> con éxito.',
                            icon: 'info',
                            iconHtml: '👋',
                            ...
                            window.location.href = '/project/pages/login/login.html';
                        });
                    } else {
                        Swal.fire({
                            title: '<strong>¡Error!</strong>',
                            html: 'Hubo un problema cerrando tu sesión. <br> <b>' + data.message +
                                '</b>',
                            icon: 'error',
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        ...
                        html: 'No pudimos procesar tu solicitud. Intenta nuevamente.',
                        icon: 'error',
