      ...
      <div class="container-xxl d-flex h-100">
        <ul class="menu-inner">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="../pages/devoluciones/vistaDevolucionesLocales.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-store"></i>
                  <div data-i18n="Generar Devolución">Generar Devolución</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="../pages/cierreCaja/cierreLocales.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-store"></i>
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
            <li class="menu-item">
            <a href="../pages/devoluciones/deposito/verDevoluciones.php" class="menu-link">
              <i class="menu-icon tf-icons bx bx-package"></i>
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="../pages/administracion/reportes/reportes.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-store"></i>
                  <div data-i18n="Subir Reporte Diario">Reporte</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="../pages/administracion/reportes/reporteVentas.php" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-store"></i>
          ...
          <li class="menu-item">
            ...
            <i class="menu-icon tf-icons bx bx-bus"></i>
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="../pages/cierreCaja/cierreChoferes.php" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-bus"></i>
