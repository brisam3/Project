                ...
                <ul class="menu-inner">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="../preventa/reporteHistoricoPreventa.php" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-chart"></i>

                                    <div data-i18n="Reporte Historico">Reporte Historico</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="../deposito/Transferencias.php" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-package"></i>
