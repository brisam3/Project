...
if (!$accessController->checkAccess('/pages/locales/ConteoStock.php')) {
                                                    ...
                                                    <form id="description-form">
                                                        ...
                                                        <div id="description-product-details" style="display: none;">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="desc-batch"
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                Swal.fire({
                                    title: '¡Éxito!',
                                    text: 'Conteo de Stock registrado con éxito.',
                                    icon: 'success',
                                ...
                                Swal.fire({
                                    title: 'Error',
                                    text: 'Ocurrió un error al registrar los conteos.',
                                    icon: 'error',
                                    confirmButtonText: 'Aceptar'
                                });
                            }
