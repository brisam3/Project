                        ...
                        <div class="content-wrapper">
                                    ...
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        <li class="nav-item col-12 col-md-6 col-lg-3 my-1" role="presentation">
                                            <button class="nav-link active" id="devoluciones-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="devoluciones" aria-selected="true">Generer Devolucion
                                            </button>
                                        </li>
                                        <li class="nav-item col-12 col-md-6 col-lg-3 my-1" role="presentation">
                                            <button class="nav-link" id="enviadas-tab" data-bs-toggle="tab"
                                                data-bs-target="#enviadas" type="button" role="tab"
                                                aria-controls="enviadas" aria-selected="false">Ver Devoluciones
                                                Enviadas</button>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="devoluciones" role="tabpanel">
                                        <div class="container-xxl flex-grow-1 container-p-y">
                                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Formulario
                                                    /</span> Carga de Stock</h4>
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-md-12">
                                                    ...
                                                    <div class="card mb-4">
                                                        <div
                                                            ...
                                                            <small class="text-muted float-end">Escanea el
                                                                código</small>
                                                        </div>
                                                        <div class="card-body">
                                                            <form id="stock-form">
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="barcode">Código de
                                                                        Barras</label>
                                                                ...
                                                                <div id="product-details" style="display: none;">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label"
                                                                            for="batch">Lote</label>
                                                                        <input type="text" class="form-control"
                                                                            id="batch" placeholder="Ingrese el lote" />
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label"
                                                    ...
                                                    <div class="card mb-4">
                                                        <div
                                                            ...
                                                            <small class="text-muted float-end">Seleccione un
                                                                artículo</small>
                                                        </div>
                                                        <div class="card-body">
                                                            <form id="description-form">
                                                                <div class="mb-3">
                                                                    <label class="form-label"
                                                                        for="search-description">Descripción</label>
                                                                    <input type="text" class="form-control"
                                                                ...
                                                                <div id="search-results" style="display: none;">
                                                                    <label class="form-label"
                                                                        for="description-results">Resultados</label>
                                                                    <select class="form-select"
                                                                        id="description-results">
                                                                        <!-- Los resultados de búsqueda se llenan aquí -->
                                                                    </select>
                                                                </div>
                                                                <div id="description-product-details"
                                                                    style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label"
                                                                            for="desc-description">Descripción</label>
                                                                        <input type="text" class="form-control"
                                                                            id="desc-description" readonly />
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label"
                                                                            for="desc-batch">Lote</label>
                                                                        <input type="text" class="form-control"
                                                                            id="desc-batch"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label"
                                                                            for="desc-quantity">Cantidad</label>
                                                                        <input type="number" class="form-control"
                                                                            id="desc-quantity"
                                                                            placeholder="Ingrese la cantidad" />
                                                                    </div>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary"
                                                                        onclick="addProductByDescription()">Agregar
                                                                        Producto</button>
                                                                </div>
                                                            </form>
                                                        </div>
                            ...
                            $(document).ready(function() {
                                ...
                                $('#description-results').on('change', function() {
                                    ...
                                    if (codBarras) {
                                        ...
                                        $('#desc-codBarras').val(
                                            codBarras
                                        ); // Almacena el código de barras en un campo oculto
                            ...
                            function addProductByDescription() {
                                ...
                                if (description && batch && quantity && codBejerman && codBarras) {
                                    // Validar duplicados
                                    const exists = productData.some(product => product.description === description);
                                    if (exists) {
                                        alert('El producto ya está en la lista.');
                                        return;
                                    }
                            ...
                            function removeProduct(button) {
                                ...
                                productData.splice(productData.findIndex(product => product.codBarras === codBarras),
                                    1);
                                row.remove();
                                updateSummary();
                            }
                            ...
                            function updateSummary() {
                                ...
                                const totalQuantity = productData.reduce((sum, product) => sum + parseInt(product
                                        .cantidad),
                                    0);
