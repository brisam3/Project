...
<head>
  ...
  <title>Importar Excel - Devoluciones Preventa</title>
  <!-- Icons -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="mb-0">Importar Archivo Excel - Devoluciones Preventa</h5>
              </div>
              <div class="card-body">
  ...
  <script>
    $(document).ready(function () {
      $('#importExcelForm').on('submit', function (e) {
        ...
        $.ajax({
          url: '../../backend/controller/administracion/ImportarDevoluciones.php',
          type: 'POST',
          data: formData,
          processData: false,
          contentType: false,
