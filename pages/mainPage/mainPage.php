                            ...
                            <div class="col-lg-8 mb-4 order-0">
                                <div class="card">
                                    <div class="d-flex align-items-end row">
                                        <div class="col-sm-7">
                                            <div class="card-body">
                                                <h5 class="card-title text-primary">Bienvenido/a 🎉</h5>
                                                <p class="mb-4">
                                                    Frase del día: Lorem ipsum dolor sit amet consectetur adipisicing
                                                    elit. Dignissimos amet animi officia
                                                </p>

                                                <a href="javascript:;" class="btn btn-sm btn-label-primary">Enviar mi
                                                    frase</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-start mb-3">
                                            ...
                                            <div class="ms-3 text-start">
                                                ...
                                                <p id="datetime" class="mb-0 fw-semibold"
                                                    style="font-size: 1rem; color: #344767;"></p>
                                            </div>
                                        </div>
                                        <hr class="my-3">
                                        <!-- Sección Clima -->
                                        <div class="d-flex align-items-center justify-content-start">
                                            ...
                                            <div class="ms-3 text-start">
                                                <h6 class="mb-0 text-muted" style="font-size: 0.9rem;">Clima en Formosa
                                                </h6>
                                                <p id="weather" class="mb-0 fw-semibold"
                                                    style="font-size: 1rem; color: #344767;"></p>
                                            </div>
                                        </div>
                                    </div>
    ...
    async function updateWeather() {
        try {
            ...
            const weatherDescription =
                `En la Ciudad de Formosa hace ${data.current.temp_c}°C y está ${data.current.condition.text.toLowerCase()}`;
