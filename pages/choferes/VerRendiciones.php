...
if (!$accessController->checkAccess('/pages/choferes/VerRendiciones.php')) {
...
<body>
                            ...
                            <div class="container-fluid !important;">
                                ...
                                <div style="width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; margin-bottom: 20px;">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="rendicionesTable" style="width: 100%; border-collapse: collapse;">
                                            <thead>
                                                <tr>
                                                    <th>Fecha</th>
                                                    <th>Preventista</th>
                                    ...
                                    <div id="detalleModal"
                                        ...
                                        <small class="text-muted float-end">
                                            <p><strong>Código de Rendición:</strong> <span id="codigoRendicion"></span>
                                        </small>
                                        ...
                                        <p><strong>Contrareembolso:</strong> $<span id="contrareembolso"></span></p>
                                        <p><strong>Diferencia:</strong> $<span id="diferencia"></span></p>
                                        <hr>
                                        
                                        <p><strong>Total Efectivo:</strong> $<span id="totalEfectivo"></span></p>
                                        <p><strong>Total Transferencia:</strong> $<span id="totalTransferencia"></span>
                                        </p>
                                        <p><strong>Total MercadoPago:</strong> $<span id="totalMercadoPago"></span></p>
                                        <p><strong>Total Cheques:</strong> $<span id="totalCheques"></span></p>
                                        <p><strong>Total Fiados:</strong> $<span id="totalFiados"></span></p>
                                        <p><strong>Total Gastos:</strong> $<span id="totalGastos"></span></p>
                                        <p><strong>Pago Secretario:</strong> $<span id="pagoSecretario"></span></p>
                                        <p><strong>Total menos Gastos:</strong> $<span id="totalMenosGastos"></span></p>
                                        <p><strong>Total MEC Faltante:</strong> $<span id="totalMecFaltante"></span></p>
    ...
    $(document).ready(function() {
        // Cargar rendiciones
        $.post('../../backend/controller/choferes/VerRendiciones.php', {
            action: 'obtenerRendiciones'
        }, function(data) {
            ...
            $(".verDetalleBtn").on("click", function() {
                ...
                $.post('../../backend/controller/choferes/VerRendiciones.php', {
                    ...
                    $("#totalGeneral").text(detalle
                        .total_general);
                    $("#diferencia").text(detalle.diferencia > 0 ? `+${parseFloat(detalle.diferencia).toFixed(2)}` : parseFloat(detalle.diferencia).toFixed(2));
