  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      columns: [
        ...
        { data: 'Stock_purchaseprice' },
        { data: 'Stock_saleprice' },
        { data: 'Stock_amount' },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $name = full['Stock_description'],
              $lastname =full['Stock_description'],
              $email = "Producto",
              $image = full['avatar'];
            if ($image) {
              // For Avatar image
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $purchasePrice = full['Stock_cod'];

            if($purchasePrice != ""){
              return '<span class="fw-semibold">' + $purchasePrice + '</span>';
            }else{
              return '<span class="fw-semibold"> Sin Código de Producto</span>';
            }
        ...
        },
        {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var $purchasePrice = full['Stock_purchaseprice'];
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $salePrice = full['Stock_saleprice'];
        ...
        },
        {
          ...
          targets: 5,
          render: function (data, type, full, meta) {
            var $stockAmount = full['Stock_amount'];
